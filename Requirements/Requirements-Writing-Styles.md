...
2 |- Information from the form is stored in the enrollment database.
3 |- A confirmation SMS is sent to the patient upon successful enrollment.
4 |- A pharmacist can view the enrollment status of a patient.
